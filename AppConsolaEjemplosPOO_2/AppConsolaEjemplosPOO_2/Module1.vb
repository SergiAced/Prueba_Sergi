Module Module1
    ...
    Sub Main()
        ...
        rec_2.Mostrar()
        cir_2.Mostrar()
        Console.WriteLine("Perimetro Decimal cir_2 es " & cir_2.Perimetro)

        ' no se puede instanciar una clase abastraccta
        ...
        Catch ex As InvalidCastException
            Console.WriteLine("Conversion NO VALIDA")
        Catch ex As Exception
            Console.WriteLine("Error de tipo " & ex.Message)
        Finally
            Console.WriteLine("SIEMPRE SE EJECTUA AL TERMINAR")
        End Try
        ...
        elementosConArea = New IConAreaCalculable() {
            rec_1,
            rec_2,
            circ,
            miVinoDonSimon
        ...
        For i = 0 To 3
            Console.WriteLine("Area calculada " & elementosConArea(i).Area)
        Next
        Console.ReadKey()
    End Sub
    Sub CalculandoAreaCirculo(cadena As String)
        Console.WriteLine("Calculando Area Circulo: " & cadena)
